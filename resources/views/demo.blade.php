...
<head>
  ...
  <script type="text/javascript" src="./onepage-scroll-master/Demo/jquery.onepage-scroll.js"></script>
  <link href='./onepage-scroll-master/Demo/onepage-scroll.css' rel='stylesheet' type='text/css'>
  ...
  <style>
    ...
    .main section.page2 {
      background: #555557 url(./onepage-scroll-master/Demo/back-phone.png) no-repeat center -150px ;
    }
    ...
    .main section.page3 {
      background:url(./onepage-scroll-master/Demo/tilted-phone.png) no-repeat 156px -150px ;
    }
...
<body>
  <div class="wrapper">
      ...
      <section class="page1">
        <div class="page_container test1">
  	    ...
  	    <img src="./onepage-scroll-master/Demo/phones.png" alt="phones">
      </section>
	    
	    <section class="page2">
	      <div class="page_container test2">
	    ...
	    <section class="page3">
	      <div class="page_container test3">
...
<script src="./onepage-scroll-master/Demo/jquery.onepage-scroll.js"></script>
